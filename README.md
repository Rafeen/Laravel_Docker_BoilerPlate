...
1. Clone this project:
   ...
   ```sh
   git clone https://github.com/Rafeen/Laravel_Docker_BoilerPlate.git
   ```

2. Inside the folder `Laravel_Docker_BoilerPlate` and Generate your own `.env` to docker compose with the next command:
